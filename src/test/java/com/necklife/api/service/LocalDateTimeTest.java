...
public class LocalDateTimeTest {
	...
	public void test() {
		...
		RangeHistorySummaryRepository rangeHistorySummaryRepository =
				new RangeHistorySummaryRepository(mongoTemplate);
		;
		...
		List<HistorySummaryEntity> historySummaryEntities =
				rangeHistorySummaryRepository.findByTimestampRange(MemberId, start);
		...
		for (HistorySummaryEntity entity : historySummaryEntities) {
			Map<LocalDateTime, PoseStatus> localDateTimePoseStatusMap =
					filterPoseStatusByTimeRange(entity, start, end);
		}
	...
	public Map<LocalDateTime, PoseStatus> filterPoseStatusByTimeRange(
			HistorySummaryEntity entity, LocalDateTime start, LocalDateTime end) {
