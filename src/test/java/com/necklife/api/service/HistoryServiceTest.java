...
public class HistoryServiceTest {
    ...
    private HistoryEntity createHistoryEntity(MemberEntity member, String startAt, String endAt, SubHistoryEntity... subHistories) {
    ...
    private SubHistoryEntity createSubHistoryEntity(String changedAt, PoseStatus status) {
