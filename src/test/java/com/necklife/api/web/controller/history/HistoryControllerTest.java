...
//
//	@MockBean private GetMonthlyDetailUseCase getMonthlyDetailUseCase;
//
...
//						.startAt(new Date("2024-07-01T00:00:00"))
//						.endAt(new Date("2024-07-25T23:59:59"))
//						.history(
//								Collections.singletonList(
//										PostureHistoryEntry.builder()
//												.startAt(new Date("2024-07-01T10:00:00"))
//												.status("FORWARD")
//												.build()))
//						.build();
//
...
//		GetMonthlyDetailResponse response = new GetMonthlyDetailResponse();
//		response.setMonth("2024-07");
//		response.setDays(
//				Collections.singletonList(
//						new GetMonthlyDetailResponse.Day(
//								"2024-07-01",
//								7200,
//								1800,
//								1200,
...
//								1,
//								Collections.singletonList(
//										new GetMonthlyDetailResponse.StatusChange(
//												"2024-07-01T09:15:00Z", 600, PostureStatus.FORWARD)))));
//
//		when(getMonthlyDetailUseCase.execute()).thenReturn(response);
//
//		mockMvc
//				.perform(
//						get(BASE_URL + "/month")
...
//
//		mockMvc
//				.perform(get(BASE_URL + "/point").header("Authorization", "Bearer {{accessToken}}"))
//				.andExpect(status().isOk())
//				.andDo(
//						document(
//								"get-history-point",
