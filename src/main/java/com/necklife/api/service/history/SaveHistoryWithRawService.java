...
public class SaveHistoryWithRawService {
    ...
    public void execute(String memberId, List<TreeMap<LocalDateTime, PoseStatus>> history, List<Map<String, String>> rawData) {
        ...
        saveSummaryHistory(memberEntity, historySummaryMap, forSaveHistorySummaryEntity,rawData,forSaveRawHistoryEntities);
    ...
    private void saveSummaryHistory(
        ...
        for (Map.Entry<LocalDate, List<HistoryEntity>> entry : historySummaryMap.entrySet()) {
            ...
            TreeMap<LocalDateTime, PoseStatus> poseStatusMap = (TreeMap<LocalDateTime, PoseStatus>) histories.get(0).getPoseStatusMap();
            ...
            RawHistoryEntity rawHistoryEntity = saveRawDataService.execute(memberEntity, historySummaryEntity, subRawData);
