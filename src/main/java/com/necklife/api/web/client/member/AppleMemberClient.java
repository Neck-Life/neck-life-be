...
public class AppleMemberClient implements SocialMemberClient{
    ...
    private String createClientSecret() {
        ...
        JWSHeader header = new JWSHeader.Builder(JWSAlgorithm.ES256).keyID(appleTokenProperties.getLoginKey()).build();
        ...
        PKCS8EncodedKeySpec spec = new PKCS8EncodedKeySpec(readPrivateKey(appleTokenProperties.getKeyPath()));
        try {
