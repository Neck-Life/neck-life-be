...
public class PostRefoundPaymentUseCase {
	...
	@Transactional
	public PostRefoundPaymentUseCaseResponse execute(
			String memberId, LocalDateTime date, String reason, Double refoundWon) {
		...
		return PostRefoundPaymentUseCaseResponse.builder().memberId(memberId).status("UNPAID").build();
	}
